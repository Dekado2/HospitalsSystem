...
public class Query_ShowEveryHospitalDetails extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Query_ShowEveryHospitalDetails(MainMenu mm) {
		...
		JLabel lblAddPerson = new JLabel("Show every hospital's details");
		...
		String header[] = new String[] {"Hospital ID" ,"Hospital Name","Department ID","Department name","Manager name","Number of doctors"};
	...
	private void initTableData(){
		...
		result = Logic.getInstance().ShowEveryHospitalDetails();
		...
		int i=0;
	 	...
	 	for(Department d:result.keySet()) {
		    ...
		    data.add(d.getHospital().getHospitalID());
		    data.add(d.getHospital().getName());
		    data.add(d.getDepartmentID());
		    data.add(d.getDepartmentName());
		    String manager= Logic.getInstance().getDepartmentManager(d.getHospital().getHospitalID(), d.getDepartmentID());
		    String managerName= Logic.getInstance().getName(manager);
		    data.add(managerName);
		    data.add(result.get(d));
		    i++;
