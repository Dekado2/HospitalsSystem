...
public class Panel_add_Doctor extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Panel_add_Doctor(MainMenu mm) {
		...
		JLabel lblAddPerson = new JLabel("Add Doctor");
		...
		panel_5.setBounds(47, 230, 292, 26);
		add(panel_5);
		...
		panel_12.setBounds(399, 230, 321, 55);
		add(panel_12);
		...
		JDateChooser graduationDate = new JDateChooser();
		...
		cbHospitalName.setBounds(183, 0, 115, 26);
		panel_13.add(cbHospitalName);
		
		JPanel panel_14 = new JPanel();
		panel_14.setLayout(null);
		panel_14.setBackground(Color.WHITE);
		panel_14.setBounds(399, 296, 149, 39);
		add(panel_14);
		...
		JCheckBox cbIsManager = new JCheckBox("");
		...
		panel_15.setBounds(47, 360, 338, 26);
		add(panel_15);
		...
		cbDepartmentName.setBounds(183, 0, 155, 26);
		...
		buttonAdd.setIcon(new ImageIcon(Panel_add_Doctor.class.getResource("/view/icons/add.png")));
		buttonAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Object[] options = {"Yes","No"};
				int n = JOptionPane.showOptionDialog(null, "Are you sure you want to add the doctor?","Add Doctor",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,null,options,options[1]);
				if (n==0)
				{
					boolean exists = Logic.getInstance().DoctorExists(tfID.getText());
					if (birthDate.getDate().after(graduationDate.getDate()))
						...
						JOptionPane.showMessageDialog(null, "Doctor " + tfID.getText() + " already exists!");
					else if (cbIsManager.isSelected())
					{
						boolean bool = Logic.getInstance().DepartmentHasManager(cbHospitalID.getSelectedItem().toString(), cbDepartmentID.getSelectedItem().toString());
						if (bool == true)
						...
						else
						{
							...
							Logic.getInstance().AddPerson(tfID.getText(), tfFirstName.getText(), tfSurName.getText(),
							    ...
							    Logic.getInstance().AddDoctor(tfID.getText(), gday, cbIsManager.isSelected(), cbHospitalID.getSelectedItem().toString(), cbDepartmentID.getSelectedItem().toString());
							    ...
							    ((JTextField)graduationDate.getDateEditor().getUiComponent()).setText("");
							    tfPhoneNumber.setText("");
							    cbIsManager.setSelected(false);
       ...
       mm.getBtnView().addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				Panel_add_Doctor.this.setVisible(false);
		...
		DocumentListener docListener = new DocumentListener() {
			...
			public void changedUpdate(DocumentEvent arg0) {
				emptyFields(tfFirstName, tfSurName, tfID, tfCity, tfStreet, birthDate, graduationDate, radioButtonFemale, radioButtonMale, tfPhoneNumber, dep, buttonAdd);
